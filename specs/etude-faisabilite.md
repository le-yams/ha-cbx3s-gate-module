...
Ce document recense les options techniques envisagées pour réaliser les fonctionnalités décrites dans `specs/besoins-fonctionnels.md` et consigne les décisions D1–D6 avec leurs justifications. Chaque section correspond à un choix ouvert.

Pour la synthèse consolidée qui intègre les décisions figées (schéma bloc, bornier, budget énergie, checklist), voir [`architecture-bloc.md`](architecture-bloc.md).
